...
class AICodeValidator:
    ...
    def analyze_document_code(self, unified_doc) -> Dict[str, Any]:
        """
        Analyze a document for code snippets, validate them using the AI model,
        ...
        prompt = f"""You are a code validation expert analyzing a document.
        Document Text: {text_to_analyze}

        TASK: Find and validate ALL code snippets in this document.

For each code snippet found:
1. Extract the code
2. Identify the programming language
3. Validate for syntax, logic, best practices, and bugs
4. Rate your confidence (0.0-1.0)
5. Note any issues and suggestions

OUTPUT ONLY THIS JSON (no markdown, no explanation):
{{
    "total_code_snippets_found": <number>,
    "validations": [
        {{
            "code": "<actual code>",
            "language": "<language>",
    ...
    "overall_assessment": {{
        "valid_snippets": <count>,
        "invalid_snippets": <count>,
